...
The `Elist` slot and class is the container workhorse for the
...
Requirements for all classes in the `Elist` are listed in the API.
...
preppedMulti <- MultiAssayExperiment(prepped$Elist, prepped$pData,
                                     prepped$sampleMap)
preppedMulti
```
