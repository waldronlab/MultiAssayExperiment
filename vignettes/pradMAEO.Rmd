...
BiocInstaller::biocLite("LiNk-NY/RTCGAToolbox", force = TRUE)
library(RTCGAToolbox)

#install biocMultiAssay
BiocInstaller::biocLite("vjcitn/MultiAssayExperiment", force = TRUE)
...
fp <- "~/GitHub/biocMultiAssay/data/prad.Rda"
load(fp)
pd <- DataFrame(extract(prad, NULL, clinical = TRUE))
