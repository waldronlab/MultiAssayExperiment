...
GitHub Source <- <a href="https://github.com/schifferl/biocMultiAssay/blob/master/vignettes/pradMAEO-RTCGAToolbox.Rmd">https://github.com/schifferl/biocMultiAssay/blob/master/vignettes/pradMAEO-RTCGAToolbox.Rmd</a><br>
  ...
  for(i in ds) {
    ...
    if(file.exists(fp)) {
        ...
        co <- getFirehoseData(i, runDate = rd, gistic2_Date = ad, RNAseq_Gene = TRUE, Clinic = TRUE, 
                              ...
                              destdir = "./tmp", fileSizeLimit = 50, getUUIDs = FALSE) #500000
        save(co, file = fp)
    }
