...
```{r}
objlist <- list(arraydat, exprdat, methyldat, microdat, rangelistdat)
```
...
subsetBySample <- function(MAobject, j, drop = FALSE){
	...
	browser()	
subElist <- lapply(MAobject@elist, FUN = function(expt) { 
#====
#TODO: Create subsetting function across experiments using subMap
#====
 } ) 
		   } else { 
