...
* Updates to `prepMultiAssay` * Enhancements to the main vignette
...
pData rownames, and `sampleMap` rows * `metadata` argument available in the `MultiAssayExperiment` constructor function
